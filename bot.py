...
ADVICES = {
    "Апатия": {
        ...
        "2": {
            ...
            "advices": ["Выпей воды", "Послушай музыку", "Включи смешное видео", "Позвони другу (даже без причины)"],
        ...
        "3": {
            ...
            "advices": ["Выпей кофе или энергетик", "Прими горячий душ", "Сделай что-то руками (уборка, рисование)", "Напиши поток сознания на бумагу"],
        ...
        "4": {
            ...
            "advices": ["Поговори с кем-то (о чём угодно)", "Выйди на улицу и уйди далеко от дома", "Крик в подушку", "Прими контрастный душ"],
        ...
        "5": {
            ...
            "advices": ["Выплачься (включи грустную музыку/фильм)", "Выплесни злость (бей подушку, рви бумагу)", "Экстренный звонок доверенному лицу", "Если есть препараты — прими (по рецепту)"],
    ...
    "Мания": {
        "1": {
            ...
            "advices": ["Направь энергию на 1 важное дело", "Запиши идеи, чтобы не забыть", "Сделай быструю разминку"],
            "risk": "Риск минимален. Энергия под контролем."
        },
        "2": {
            "description": "Сфокусируй энергию на одном деле, избегай многозадачности.",
            "advices": ["Сфокусируйся на одном деле", "Избегай многозадачности", "Пей воду маленькими глотками"],
            "risk": "Лёгкая перегрузка. Возможна тревожность."
        },
        "3": {
            "description": "Выпей воды. Поешь вкусняшек. Просто приляг и ничего не делай.",
            "advices": ["Выпей воды", "Поешь вкусняшек", "Приляг на 10 минут", "Включи белый шум"],
            "risk": "Средняя перегрузка. Может начаться тремор."
        },
        "4": {
            "description": "Время лечь и ничего не делать, совсем. Включи тупой видос.",
            "advices": ["Ляг и ничего не делай", "Включи «тупой» видеоролик", "Дыхание 4-7-8 (вдох-задержка-выдох)", "Холодные ладони на лицо"],
            "risk": "Высокая перегрузка. Риск иррациональных решений."
        },
        "5": {
            "description": "Состояние критическое. Немедленно остановись.",
            "advices": ["Немедленно остановись", "Прими успокоительное (если прописано)", "Вызови друга/родственника", "Горячее сладкое питьё"],
